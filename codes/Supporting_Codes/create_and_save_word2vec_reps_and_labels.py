...
train_anger = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/train/anger.txt',delimiter='\t',header=None)
train_fear = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/train/fear.txt',delimiter='\t',header=None)
train_joy = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/train/joy.txt',delimiter='\t',header=None)
train_sad = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/train/sadness.txt',delimiter='\t',header=None)


# In[ ]:

dev_anger = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/dev/anger.txt',delimiter='\t',header=None)
dev_fear = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/dev/fear.txt',delimiter='\t',header=None)
dev_joy = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/dev/joy.txt',delimiter='\t',header=None)
dev_sad = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/dev/sadness.txt',delimiter='\t',header=None)


# In[ ]:

test_anger = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/test/evalanger.txt',delimiter='\t',header=None)
test_fear = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/test/evalfear.txt',delimiter='\t',header=None)
test_joy = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/test/evaljoy.txt',delimiter='\t',header=None)
test_sad = pd.read_csv('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/data/test/evalsadness.txt',delimiter='\t',header=None)
...
model = gensim.models.KeyedVectors.load_word2vec_format('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/wordvec_model/word2vec_twitter_model.bin',binary=True,unicode_errors='ignore')
...
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/train/anger.npy',
        train_anger_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/train/fear.npy',
        train_fear_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/train/joy.npy',
        train_joy_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/train/sadness.npy',
        train_sadness_vecs)
...
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/dev/anger.npy',
        dev_anger_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/dev/fear.npy',
        dev_fear_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/dev/joy.npy',
        dev_joy_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/dev/sadness.npy',
        dev_sadness_vecs)
...
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/test/evalanger.npy',
        test_anger_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/test/evalfear.npy',
        test_fear_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/test/evaljoy.npy',
        test_joy_vecs)
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/word2vec_based_concatenated_vectors/test/evalsadness.npy',
        test_sadness_vecs)
...
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/train/anger.npy',np.array(train_anger_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/train/fear.npy',np.array(train_fear_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/train/joy.npy',np.array(train_joy_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/train/sadness.npy',np.array(train_sad_intensities))        


# In[ ]:

np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/dev/anger.npy',np.array(dev_anger_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/dev/fear.npy',np.array(dev_fear_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/dev/joy.npy',np.array(dev_joy_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/dev/sadness.npy',np.array(dev_sad_intensities))        


# In[ ]:

np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/test/evalanger.npy',np.array(test_anger_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/test/evalfear.npy',np.array(test_fear_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/test/evaljoy.npy',np.array(test_joy_intensities))
np.save('C:/Users/chaeh/Downloads/Neutral_Emotion_Intensity_Prediction/intermediate_files/gold_label_vectors/test/evalsadness.npy',np.array(test_sad_intensities))
